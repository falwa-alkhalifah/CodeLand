...
--
-- Host: localhost:3306
-- Generation Time: Nov 09, 2025 at 07:53 PM
...
(19, 1, 'Which tag is used to create an unordered list?', NULL, '<ul>', '<ol>', '<list>', '<li>', 'A');
...
(1, 1, 2, 'Which tag is used to create an unordered list?', NULL, '<ul>', '<ol>', '<list>', '<li>', 'A', 'approved', ''),
(2, 1, 2, 'Which attribute is used to define inline CSS styles in HTML?', NULL, 'class', 'style', 'id', 'css', 'B', 'pending', NULL),
